...
interface ImportMetaEnv {
  ...
  readonly VITE_USE_INVENTARIO_SERVICE_CREATE?: string;
  readonly VITE_USE_INVENTARIO_SERVICE_UPDATE?: string;
  readonly VITE_USE_INVENTARIO_SERVICE_DELETE?: string;
