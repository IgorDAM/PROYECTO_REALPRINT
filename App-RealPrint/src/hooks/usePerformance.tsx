 ...
 */
export function lazyLoad<T extends ComponentType<any>>(importFunc: LazyImport<T>) {
  const Component: LazyExoticComponent<T> = lazy(importFunc);
 ...
 * );
 */
export function useIntersectionObserver(options: IntersectionObserverInit = {}): IntersectionObserverResult {
