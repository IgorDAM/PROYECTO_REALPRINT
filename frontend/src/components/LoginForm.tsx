...
export default function LoginForm() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      {/* Skeleton loading mientras se autentica */}
      {loading && (
        <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl flex items-center justify-center z-50">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm text-surface-600 font-medium">Verificando tus credenciales...</p>
            <p className="mt-1 text-xs text-surface-500">Esto puede tomar unos segundos si es la primera carga</p>
          </div>
        </div>
      )}
